...
* TODO Use it for this very file as well
* TODO Add et alias
clojure -M -m jakub-stastny.et.runner et.org *args

* TODO Describe how to use PROPERTIES to override shebang (say to bb)
