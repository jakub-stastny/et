...
* Usage
ET allows you to run any task defined in code blocks in org-mode files, such as this ~chapters/index.org~.
...
#+begin_src sh :task yes :exports none
  # This is so the example actually works, but this block doesn't show in the generated documentation (the one above does).
  echo "Hey there literates!"
#+end_src
